...
#define MT_COMPAT scp_pd_mask_table
...
/* generate all scp_pd_mask_table table instances */
DT_FOREACH_OKAY_INST_scp_pd_mask_table(MT_TABLE_INIT)
...
#define PD_COMPAT scp_power_domain
...
static struct fwk_element element_table[] = {
    ...
    DT_FOREACH_OKAY_INST_scp_power_domain(PD_ELEM_INIT)
    /* last null element */
    [DT_N_INST_scp_power_domain_NUM_OKAY] = { 0 },
};
