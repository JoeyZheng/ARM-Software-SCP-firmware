...
#define MCLK_COMPAT scp_mock_clock
...
DT_FOREACH_OKAY_INST_scp_mock_clock(MCLK_RATE_TABLE_INIT)
...
static struct fwk_element element_table[] = {
    ...
    DT_FOREACH_OKAY_INST_scp_mock_clock(MCLK_ELEM_INIT)
    // last null element
    [DT_N_INST_scp_mock_clock_NUM_OKAY] = { 0 },
};
