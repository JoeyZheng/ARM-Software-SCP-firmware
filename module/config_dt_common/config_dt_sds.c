...
#define SDS_R_COMPAT scp_sds_region
...
static const struct mod_sds_region_desc sds_module_regions[] = {
    DT_FOREACH_OKAY_INST_scp_sds_region(SDS_R_TABLE_ENT)
};

/* sds config data */
static const struct mod_sds_config sds_module_config = {
    .regions = sds_module_regions,
    .region_count = (unsigned int)DT_N_INST_scp_sds_region_NUM_OKAY,
    .clock_id = FWK_ID_NONE_INIT,
};

/* SDS element table */
#define SDS_COMPAT scp_sds
...
static struct fwk_element element_table[] = {
    ...
    DT_FOREACH_OKAY_INST_scp_sds(SDS_ELEM_INIT)
    /* last NULL element */
    [DT_N_INST_scp_sds_NUM_OKAY] = { 0 },
};
