...
#define MOD_PL011_COMPAT scp_mod_arm_pl011
#define PH_HW_NAME scp_hardware

#define PL011_PROP(n, prop) FWK_DT_INST_PROP(PL011_COMPAT, n, prop)
#define PL011_PH_PROP(n, prop) FWK_DT_PH_INST_PROP(MOD_PL011_COMPAT, n, PH_HW_NAME, prop)

#ifdef BUILD_HAS_MOD_CLOCK

#define CFG_PL011_ELEMENT_DATA(n) \
    .reg_base = DT_REG_ADDR_BY_IDX(DT_PHANDLE(DT_INST(n, MOD_PL011_COMPAT), PH_HW_NAME), 0),    \
    .baud_rate_bps = PL011_PH_PROP(n, current_speed), \
    .clock_rate_hz = PL011_PH_PROP(n, clock_frequency), \
    .clock_id = FWK_ID_NONE_INIT, \
    .pd_id = FWK_DT_PH_IDX_SCP_ID_BY_TYPE(MOD_PL011_COMPAT, n, 0),
...
static struct fwk_element pl011_element_table[] = {
            ...
            DT_FOREACH_OKAY_INST_scp_mod_arm_pl011(CFG_PL011_ELEMENT_INIT)
            // last null element
            [DT_N_INST_scp_mod_arm_pl011_NUM_OKAY] = { 0 },
};
