...
#define CFG_CLK_DEV_ELEM_DATA_PH(n) \
    .driver_id = FWK_DT_PH_IDX_SCP_ID_BY_TYPE(CLK_DEV_COMPAT, n, 0), \
    .api_id = FWK_DT_PH_IDX_SCP_ID_BY_TYPE(CLK_DEV_COMPAT, n, 1), \
    .pd_source_id = FWK_DT_PH_IDX_SCP_ID_BY_TYPE_OR_NONE(CLK_DEV_COMPAT, n, 2),
