...
#define SCMI_SVC_COMPAT scp_scmi_service
...
static struct fwk_element element_table[] = {
    ...
    DT_FOREACH_OKAY_INST_scp_scmi_service(SCMI_SVC_ELEM_INIT)
    /* last NULL element */
    [DT_N_INST_scp_scmi_service_NUM_OKAY] = { 0 },
};
...
static_assert(DT_N_INST_scp_scmi_NUM_OKAY == 1,
